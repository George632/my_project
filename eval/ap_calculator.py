            ...
            for eps in [self.eps, self.eps + 0.05]:
                ...
                if p_corners.size != 0:
                    ...
                    if pred_edges.size != 0:
                        ...
                        if save_wireframe and eps == (self.eps):
                            save_wireframe_model(pred_edges_corners * self.max_distance[b] + self.centroid[b],
                                                 p_edges_index, './results/' + str(self.scan_idx[b][0]) +'.obj')
...
def dbscan_to_parse_corners(pred_edges, eps, min_samples):
    ...
    # edges_vertices = pred_vertices_copy
